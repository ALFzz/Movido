...
export const FilmInfo = () => {
    ...
    return(
        <>
            <div className='plot'>
                <h1 className='plot-title'>Сюжет</h1>
                <h2 className='plot-desc'>Агент Кей и Джей участвуют в операции по поимке беглого инопланетянина. После её окончания Ди объявляет, что стал слишком стар для такой работы и уходит на пенсию. Агенту Кей нужен новый напарник.
...
Тем временем неподалёку от Нью-Йорка падает космический корабль. Инопланетянин убивает фермера Эдгара и надевает на себя его кожу. Агенты осматривают место крушения и устанавливают, что на планету прибыл «Жук» — опасный вид тараканоподобных пришельцев. Жук знает, что где-то на Земле хранится галактика, являющаяся источником субатомной энергии, и собирается завладеть бесценным объектом. «Люди в черном» должны остановить жука и предотвратить серьёзный межпланетный конфликт. </h2>
            ...
            <div className='info'>
                ...
                <span>
                    <h2 className='info-desc'>Страна</h2>
                    <h2 className='info-ans'>США</h2>
                </span>

                <span>
                    <h2 className='info-desc'>Жанры</h2>
                    <h2 className='info-ans'>Комедия, боевик</h2>
                </span>

                <span>
                    <h2 className='info-desc'>Режиссёр</h2>
                    <h2 className='info-ans'>Барри Зонненфельд</h2>
                </span>
